...
<body>
	...
	<a href="../index.jsp" class="btn btn-success btn-arrow-left">AppleMango 메 인</a>
			...
			<div class="row">
				<table class="table table-striped"
					...
					<tr>
							...
							<th style="background-color: white; height:10%; "><%=list.get(i).getBbsCount()%></th>
						</tr>
						<%
							}
						%>
...
<!-- Footer-->
        <footer class="footer text-center" style="background : #000 !important;">
            <div class="container">
                <div class="row">
                    <!-- Footer Location-->
