			...
			<div class="head">
				<table class="table table-striped"
					...
					<thead>
						<tr>
							<th colspan="2"
								style="background-color:  #2c3e50; text-align: center; color:white; width:100%;">글
								수정 </th>
						</tr>
					</thead>
					<tbody>
					...
					<input style="background-color:  #2c3e50;" type="submit" class="btn btn-primary pull-right" value="글수정" />
			</form>
		</div>
	</div>
	<!-- 애니매이션 담당 JQUERY -->
