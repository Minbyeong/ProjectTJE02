...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%
session.setAttribute("id", "kyjun92@gmail.com");
String id = (String) session.getAttribute("id");
	DAO dao = new DAO();
JSONObject jo = dao.music_top();
%>
<!DOCTYPE html>
<html>
<head>
...
function music_delete(x) {
	...
	$(function() {
		...
		for (var i = 0; i < memberData.music.length; i++) {
			$('#m_content')
					.append(
							'<div style="display: grid; grid-template-columns: [left-edge] 50px[artwork-edge] 400px[title-edge] 300px[right-edge] 150px; grid-column-gap: 20px; border-bottom: 1px solid lightgray; padding:5px;height:62px;"><div><img alt="" src="'
							+memberData.music[i].img+'" width="100%" style="border-radius: 5px;"></div><div style="padding:5px"><a href="#"style="font-size: 20px;font-weight:bolder;">'
							+memberData.music[i].title+'</a><br><a href="#" style="font-size: 10px">'
							+memberData.music[i].artist+'</a></div><div style="padding-top:15px">'+memberData.music[i].genre+'</div><div style="padding-top:15px;"><img src="img/play_icon.png" onclick="music_plus('
								+ i
...
<body>
	<div class="apple-music">
		...
		<main style="width: 2000px; margin-left: 220px;">
			<div class="c-playback" style="position: fixed; fill: #000;">
				...
				<div class="c-playback__lcd">
					<div id="nowplaying-img"
						style="width: 45px; height: 100%; position: absolute; left: 0;">
						<img alt=""
			...
			<div class="m_main"
				style="width: 1000px; padding: 20px; margin-top: 50px">
				<div class="music_box" style="padding: 10px;">
					<h3 style="margin: 10px;">Top 100</h3>
				</div>
				<div id="m_content" style="padding: 10px">
					<div
						style="display: grid; grid-template-columns: [left-edge] 50px[artwork-edge] 400px[title-edge] 300px[right-edge] 150px; grid-column-gap: 20px; border-top: 1px solid lightgray; border-bottom: 1px solid lightgray; padding: 5px;">
						<div></div>
						<div>곡정보</div>
						<div>장르</div>
						<div>듣기</div>
