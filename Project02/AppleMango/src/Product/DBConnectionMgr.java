...
public class DBConnectionMgr { 
    //db연결 1,2 단계를 대신해서 처리해준다.
    //db의 자료를 이용할 때마다 연결을 만들고 자료를 넣고 빼고를 진행하는 것은 효율이 매우 떨어지기 때문에
    //미리 db의 연결을 10정도 만들어서 유지를 해준다.
    private Vector connections = new Vector(10);
    private String _driver = "com.mysql.jdbc.Driver",
    _url = "jdbc:mysql://localhost:3366/applemango",
    _user = "root",
    _password = "1234";
